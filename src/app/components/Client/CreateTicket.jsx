          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-gray-500 ml-1">Choisissez la catégorie qui correspond le mieux à votre demande</p>
              </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                required
              />
              <p className="text-gray-500">Résumez votre problème en quelques mots</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                required
              ></textarea>
              <p className="text-gray-500">Incluez toutes les informations pertinentes (étapes, messages d'erreur, etc.)</p>
            </div>
              ...
              <CardContent className="p-4">
                <div className="flex gap-3">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-blue-900">Conseils pour une réponse rapide</h4>
