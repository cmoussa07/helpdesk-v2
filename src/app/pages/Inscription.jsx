...
//       <Card className="w-full max-w-lg border-2 border-blue-100 shadow-xl">
...
//           </CardTitle> */}
//           <CardTitle className="text-center text-2xl font-bold">
//             Créez votre compte Helpdesk
//           </CardTitle>
//           <CardDescription className="text-center text-sm text-gray-600 pt-3 pb-3">
